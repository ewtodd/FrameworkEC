...
## This code comes with no warranty, guaranties of functionality, etc. If you do not have the capability to recover from a bad flash, do not mess with the firmware.  
